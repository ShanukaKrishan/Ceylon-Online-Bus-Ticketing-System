...
class ResultScreen extends StatefulWidget {
  ResultScreen(
      {this.uid, this.start, this.destination, this.subDate, this.subType});
  final uid;
  final start;
  final destination;
  final subDate;
...
class _ResultScreenState extends State<ResultScreen> {
  ...
  void setUID(dynamic uid, dynamic start, dynamic destination, dynamic subDate,
      dynamic subType) {
    setState(() {
      userID = uid;
      startLoc = start;
  ...
  void initState() {
    ...
    super.initState();
    setUID(widget.uid, widget.start, widget.destination, widget.subDate,
        widget.subType);
  }
